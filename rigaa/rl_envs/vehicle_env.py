...
class CarEnvEval(Env):
    ...
    def step(self, action):
        ...
        if self.done is True:
            ...
            new_reward, self.car_path = (car.execute_road(intp_points))
            new_reward = abs(new_reward)
            ...
            if new_reward > self.max_fitness:
                reward += 50
    ...
    def render(self, scenario, mode='human'):
        ...
        #fig.savefig(cf.files["img_path"] + str(self.episode) + "_" + str(fitness) + ".png")
