...
def parse_arguments():
    ...
    parser.add_argument('--ro', type=float, default=0.4, help='Percentage of the initial population generated by the RL agent. Possible values from 0 to 1.')
    
    arguments = parser.parse_args()
    return arguments


def main(problem, algo, runs_number, save_results, random_seed, debug, n_eval, full, eval_time, ro=0.4):
    """
...
if __name__ == "__main__":
    ...
    main(args.problem, args.algorithm, args.runs, args.save_results, args.seed, args.debug, args.n_eval, args.full, args.eval_time, args.ro)
